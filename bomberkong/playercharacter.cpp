...
void PlayerCharacter::collisionEvent(Entity * body)
{
    ...
    if ((dynamic_cast<Level*>(parent)->getItsSceneType() == RELOADED && dynamic_cast<Barrel*>(body) != nullptr && !(dynamic_cast<Barrel*>(body)->getIsFlying())) || (dynamic_cast<Level*>(parent)->getItsSceneType() != RELOADED && dynamic_cast<Barrel*>(body) != nullptr) || dynamic_cast<Explosion*>(body) != nullptr || dynamic_cast<Flame*>(body) != nullptr)
    {
