...
void Widget::win(){
    deleteEntities();
    createEntity(new Character(10 * cellSize, 13 * cellSize));
    createEntity(new BomberGirl(9 * cellSize, 13 * cellSize));
    isWin = true;
...
void Widget::paintEvent(QPaintEvent *)
{
    ...
    if(Input::isActionPressed(PAUSE) == true && state != MENU && nbLive > -1){
